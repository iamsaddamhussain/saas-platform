...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the base domain used for multi-tenancy. Subdomains will be 
    | created for each tenant (e.g., tenant.yourdomain.com)
    |
    */

    'domain' => env('APP_DOMAIN', 'saas-platform.localhost'),
